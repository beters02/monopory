...
## Scope
These are **workspace-only** instructions for the monopory project. Ignore global/user Cursor rules that duplicate or conflict with files in this repo (`.cursor/rules/`).

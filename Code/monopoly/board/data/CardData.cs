...
public static class CardData
{
	...
	public static List<CardDef> CreateChanceCards()
	{
		return new()
		{
			...
			new() { Key = "chance_advance_railroad", Deck = CardDeck.Chance, Title = "Take a ride", Description = "Move to {space_5}. Collect ${pass_go_money} if you pass {space_0}.", Action = CardAction.MoveToSpace, TargetSpaceIndex = 5 },
			new() { Key = "chance_advance_nearest_railroad", Deck = CardDeck.Chance, Title = "Advance to nearest Railroad", Description = "Move to the nearest Railroad. Collect ${pass_go_money} if you pass {space_0}.", Action = CardAction.MoveToNearestRailroad, Weight = 2 },
			new() { Key = "chance_advance_nearest_utility", Deck = CardDeck.Chance, Title = "Advance to nearest Utility", Description = "Move to the nearest Utility. Collect ${pass_go_money} if you pass {space_0}.", Action = CardAction.MoveToNearestUtility },
			...
			new() { Key = "chance_go_jail", Deck = CardDeck.Chance, Title = "Go to {space_10}", Description = "Go directly to {space_10}. Do not collect ${pass_go_money}.", Action = CardAction.GoToJail },
			...
			new() { Key = "chance_gamble_coin_flip", Deck = CardDeck.Chance, Title = "Gamble Card", Description = "You're forced to play in a coinflip for a random amount.", Action = CardAction.Gamble, Amount = 150, Weight = 1 },
	...
	public static List<CardDef> CreateCommunityChestCards()
	{
		return new()
		{
			new() { Key = "chest_advance_go", Deck = CardDeck.CommunityChest, Title = "Advance to {space_0}", Description = "Collect ${go_landing_money}.", Action = CardAction.MoveToSpace, TargetSpaceIndex = 0 },
			...
			new() { Key = "chest_go_jail", Deck = CardDeck.CommunityChest, Title = "Go to {space_10}", Description = "Go directly to {space_10}. Do not collect ${pass_go_money}.", Action = CardAction.GoToJail },
			...
			new() { Key = "chest_gamble_coin_flip", Deck = CardDeck.CommunityChest, Title = "Gamble Card", Description = "You're forced to play in a coinflip for a random amount.", Action = CardAction.Gamble, Amount = 150, Weight = 1 }
		};
	}

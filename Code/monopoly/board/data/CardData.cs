...
public static class CardData
{
	...
	public static List<CardDef> CreateChanceCards()
	{
		...
		return new()
		{
			...
			new() { Key = "chance_advance_illinois", Deck = CardDeck.Chance, Title = "Advance to The Co-Op", Description = "Move to The Co-Op. Collect $200 if you pass GO.", Action = CardAction.MoveToSpace, TargetSpaceIndex = 26 },
